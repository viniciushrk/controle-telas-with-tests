...
public class PessoaTest {
    ...
    @Test
    public void criaPessoaValida() throws Exception {
    ...
    @Test
    public void profissaoPadraoDeveSerNenhum() throws Exception {
        //TODO criar um enum de profissoes
        var pessoa = new Pessoa("Windson","Gadelha","windson@gmail.com");
        assertTrue(pessoa.getProfissao().equals(ProfissaoEnum.Nenhum));
    }

    @Test
    public void naoDeveConterNenhumaDisciplinaEmPessoa() throws Exception {
    ...
    @Test
    public void pessoaTemBolsa() throws Exception {
